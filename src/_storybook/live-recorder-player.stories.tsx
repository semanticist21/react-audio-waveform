  ...
  return (
    <div className="flex h-screen w-full items-center justify-center bg-slate-100">
      <div className="flex h-24 w-fit items-center gap-4 rounded-2xl bg-white px-5 shadow-lg">
        ...
        <LiveRecorder mediaRecorder={mediaRecorder} className="h-12 w-88 rounded-lg bg-slate-100 text-slate-600" />
...
function LiveRecorderPlayerWithDownload() {
  const {
    startRecording,
    stopRecording,
    pauseRecording,
...
export const WithPlay: StoryObj<typeof LiveRecorderPlayerWithPlay> = {
  ...
  parameters: {
    docs: {
      source: {
        code: `function LiveRecorderPlayerWithPlay() {
  const {
    startRecording,
    stopRecording,
    pauseRecording,
...
export const WithDownload: StoryObj<typeof LiveRecorderPlayerWithDownload> = {
  render: () => <LiveRecorderPlayerWithDownload />,
  parameters: {
    docs: {
      source: {
        code: `function LiveRecorderPlayerWithDownload() {
  const {
    startRecording,
    stopRecording,
    pauseRecording,
